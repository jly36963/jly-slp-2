...
var firebase_admin_1 = require("../utils/firebase-admin");
// validate firebase token/uid
var checkToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, uid, token, decodedToken, isValidToken;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.headers, uid = _a.uid, token = _a.token;
            ...
            case 1:
                ...
                isValidToken = uid === decodedToken.uid;
                if (!isValidToken)
                    return [2 /*return*/, res.status(401)];
                // success
                next();
